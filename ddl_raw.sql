IF OBJECT_ID('raw.olist_customers', 'U') IS NOT NULL
	DROP TABLE raw.olist_customers;
GO 
...
GO
IF OBJECT_ID('raw.olist_geolocation', 'U') IS NOT NULL
	DROP TABLE raw.olist_geolocation;
GO
...
GO
IF OBJECT_ID('raw.olist_order_items', 'U') IS NOT NULL
	DROP TABLE raw.olist_order_items;
GO
...
GO
IF OBJECT_ID('raw.olist_order_payments', 'U') IS NOT NULL
	DROP TABLE raw.olist_order_payments;
GO
...
GO
IF OBJECT_ID('raw.olist_order_reviews', 'U') IS NOT NULL
	DROP TABLE raw.olist_order_reviews;
GO
...
GO
IF OBJECT_ID('raw.olist_orders', 'U') IS NOT NULL
	DROP TABLE raw.olist_orders;
GO
...
GO
IF OBJECT_ID('raw.olist_products', 'U') IS NOT NULL
	DROP TABLE raw.olist_products;
GO
...
GO
IF OBJECT_ID('raw.olist_sellers', 'U') IS NOT NULL
	DROP TABLE raw.olist_sellers;
GO 
...
GO
IF OBJECT_ID('raw.products_category_name_translation', 'U') IS NOT NULL
	DROP TABLE raw.products_category_name_translation;
GO
CREATE TABLE raw.products_category_name_translation (
